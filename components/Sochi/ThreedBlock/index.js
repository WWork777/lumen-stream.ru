        ...
        <div className='threedblock'>
            ...
            <div className='threedblock-text-block'>
                <div className='threedblock-text-container'>
                    <p className='threedblock-text'>Мы понимаем, как сложно начинать карьеру в новом <br></br> городе. Tipme Studio предлагает иногородним моделям <br></br> полную поддержку:</p>
                ...
                <div className='threedblock-text-container-mobile'>
                    <p className='threedblock-text'>Мы понимаем, как сложно начинать карьеру в новом городе. Tipme Studio предлагает иногородним моделям полную поддержку:</p>
