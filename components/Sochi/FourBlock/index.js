        ...
        <div className='fourblock'>
            ...
            <div className="ag-format-container-sochi">
                <div className='fourblock-cards-top'>
                    <Card text='Забота – ключ к успеху: Tipme Studio создает комфорт и душевное спокойствие для моделей.'/>
                    <Card text='Уверенность и удовольствие: Tipme Studio заботится о вашей безопасности и комфорте.'/>
                </div>
                <div className='fourblock-cards-top'>
