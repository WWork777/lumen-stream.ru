...
const MainForm = () => {
  ...
  const phoneRegex =
    /^(?:8|\+7)\s?\(?\d{3}\)?\s?\d{3}[-]?\d{2}[-]?\d{2}$|^(?:\+7|8)\s?\d{3}[\s-]?\d{3}[\s-]?\d{2}[\s-]?\d{2}$/;
  ...
  const validateForm = () => {
    ...
    if (!formData.city) newErrors.city = "Пожалуйста, введите ваш город";
      ...
      newErrors.city = "Город может содержать только буквы и пробелы";
    ...
    if (
      formData.contactMethod === "vk" &&
      formData.vkid &&
      !vkIDRegex.test(formData.vkid)
    ) {
      newErrors.vkid =
        "VK ID может содержать только буквы, цифры и подчеркивание";
    }

    if (
      formData.contactMethod === "telegram" &&
      formData.telegramNick &&
      !telegramNickRegex.test(formData.telegramNick)
    ) {
      newErrors.telegramNick =
        "Ник в Telegram может содержать только буквы, цифры и подчеркивание";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = {
      ...
      contactMethod: activeButton || "Способ связи не выбран",
      page: "Главная страница",
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          phone: "",
          telegramNick: "",
          contactMethod: "Способ связи не выбран",
          vkid: "",
          page: "Главная страница",
        });
      } else {
  ...
  return (
    <>
      <div className="main-form">
        <h2>
          Заполнение <span>анкеты</span>
        </h2>
        <p className="main-form-text">
          Давайте скорее знакомиться - расскажите о себе с помощью небольшой
          анкеты или напишите нам в любой мессенджер. После этого мы свяжемся с
          вами и приступим к более подробному знакомству!
        </p>
        <form className="main-form-form" onSubmit={handleSubmit}>
          ...
          {activeButton === "telegram" && (
            <>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, telegramNick: e.target.value })
                }
              />
              {errors.telegramNick && (
                <span
          ...
          {activeButton === "vk" && (
            <>
              ...
              <input
                ...
                value={formData.vkid}
                onChange={(e) =>
                  setFormData({ ...formData, vkid: e.target.value })
                }
              />
              {errors.vkid && (
                <span
          ...
          <div className="main-form-toggle">
            ...
            <div className="main-form-toggle-button">
              <button
                ...
                className={`toggle-button-tg ${
                  activeButton === "telegram" ? "active" : ""
                }`}
              >
                <svg
            ...
            <div className="main-form-toggle-button">
              <button
                ...
                className={`toggle-button-viber ${
                  activeButton === "vk" ? "active" : ""
                }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="main-form-button">
            <button type="submit" className="main-form-send">
              Отправить
            </button>
          </div>
        </form>
