    ...
    return (
        <>
            <div className='city-form'>
                <h1>Заполнение <span>анкеты</span></h1>
                <p className='main-form-text'>Давайте скорее знакомиться - расскажите о себе с помощью небольшой анкеты или напишите нам в любой мессенджер. После этого мы свяжемся с вами и приступим к более подробному знакомству!</p>
                ...
                {activeButton === 'vk' && (
                    ...
                    <div className='main-form-toggle'>
                        <p>Где вам написать?</p>
                        <div className='main-form-toggle-button'>
                        <button
                            type="button"
